package com.example.backendtaskapp.repository
...
class TaskRepositoryEmbeddedTest {
    ...
    fun `when task is saved then check for not null`() {
        // Given
        // When
        val task: Task = this.objectUnderTest
            .findTaskById(111)
    ...
    fun `when description is queried then check if description already exists`() {
        ...
        val doesDescriptionExist2 = objectUnderTest.doesDescriptionExist("take care the birds")
